...
If $\type{E[t]}{\effectType{T}}$ then for all $U, M, I$ such that for all $\Var{\alpha}{T} \text{ or } \Binder{\alpha}{T} \in t$, $\alpha \in U$ either 
\begin{enumerate}
...
\begin{enumerate} 
  ...
  \end{enumerate}
  then $\Gamma \vdash E'[t']: T$ and for all $\Var{\alpha}{T} \text{ or } \Binder{\alpha}{T} \in t'$, $\alpha \in U'$
\end{theorem}
