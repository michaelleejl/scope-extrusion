...
In contrast, level $0$ compile-time values (the first row in \Cref{table:type-strat}) cannot be directly created in \sourceLang{} (but $T^0$ is used to type level $0$ \textit{formal parameters}). 
\[\begin{array}{ll}
