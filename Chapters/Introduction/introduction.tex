...
\begin{enumerate}
    ...
    \item In \calculusName{}, a formal description of a novel Dynamic Best-Effort check (\Cref{section:best-effort-check}), which I prove correct (\Cref{subsection:best-effort-correct}), and argue, by comparison with other checks, occupies a ``goldilocks zone'' between expressiveness (\Cref{subsection:best-effort-expressive}) and efficiency (\Cref{subsection:best-effort-efficient}). 
