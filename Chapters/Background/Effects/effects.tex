...
The typing rules for terms are collated in \Cref{fig:efflang-type-system}. The key rules are \textsc{Return}, \textsc{Do}, \textsc{Op}, and the handler rules (\textsc{Ret-Handler}, \textsc{Op-Handler}).
