...
\newcommand{\varToAST}[1]{\return{{\texttt{Var}}({#1})}}
...
%   skin=tile,
 ...
 \newcommand{\recLang}{\sourceLang$^{\gamma}$}
...
%   skin=tile,
 ...
 \newtcolorbox{rec-desc}{
  common,
  % minted language=lexers/macocaml.py:MacocamlLexer,
  colback=white,
  fontupper=\small,
  borderline north={0.5mm}{0mm}{recHighlight,line width=1pt},
borderline south={0.5mm}{0mm}{recHighlight,line width=1pt},
  overlay={\node[fill=recHighlight,yshift=-10pt,xshift=-10pt,left,text=white,
         anchor=east,font=\footnotesize\ttfamily\bfseries] at (frame.north east){\recLang{}};}
%   skin=tile,
 }
...
%   skin=tile,
 ...
 \newtcolorbox{rec}{
  common,
  % minted language=ocaml,
  colback=recBackground,
  fontupper=\linespread{1.1}\footnotesize,
  after={\par\vspace{0.2\baselineskip}\noindent},
  % listing engine=minted,
  % minted options = {linenos, fontsize=\footnotesize, numbersep=15pt, baselinestretch=1.1, escapeinside=!!},
  overlay={\node[fill=recHighlight,yshift=-10.7pt,xshift=-10pt,left,text=white,
         anchor=east,font=\footnotesize\ttfamily\bfseries] at (frame.north east){\recLang{}};}
%   skin=tile,
 }
